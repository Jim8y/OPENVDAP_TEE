...
enum
{
    openvdap_fcn_id_ecall_openvdap_init_tee = 0,
    openvdap_fcn_id_ecall_openvdap_open_keynote = 1,
    openvdap_fcn_id_ecall_openvdap_execute_cmd = 2,
    openvdap_fcn_id_ecall_openvdap_close_keynote = 3,
    openvdap_fcn_id_ecall_openvdap_execute_cmd_add = 4,
    openvdap_fcn_id_ecall_openvdap_execute_cmd_update = 5,
    openvdap_fcn_id_ecall_openvdap_execute_cmd_delete = 6,
    openvdap_fcn_id_ecall_openvdap_execute_cmd_query = 7,
    openvdap_fcn_id_ecall_openvdap_execute_cmd_enc = 8,
    openvdap_fcn_id_ecall_openvdap_execute_cmd_dec = 9,
    openvdap_fcn_id_ecall_openvdap_execute_cmd_sign = 10,
    openvdap_fcn_id_ecall_openvdap_execute_cmd_verify = 11,
    openvdap_fcn_id_initialize_encryptor = 12,
    openvdap_fcn_id_encrypt_block = 13,
    openvdap_fcn_id_close_encryptor = 14,
    openvdap_fcn_id_oe_get_sgx_report_ecall = 15,
    openvdap_fcn_id_oe_get_report_v2_ecall = 16,
    openvdap_fcn_id_oe_verify_local_report_ecall = 17,
    openvdap_fcn_id_oe_sgx_init_context_switchless_ecall = 18,
    openvdap_fcn_id_oe_sgx_switchless_enclave_worker_thread_ecall = 19,
    openvdap_fcn_id_trusted_call_id_max = OE_ENUM_MAX
};

/**** Trusted function names. ****/
static const oe_ecall_info_t _openvdap_ecall_info_table[] = 
{
    { "ecall_openvdap_init_tee" },
    { "ecall_openvdap_open_keynote" },
    { "ecall_openvdap_execute_cmd" },
    { "ecall_openvdap_close_keynote" },
    { "ecall_openvdap_execute_cmd_add" },
    { "ecall_openvdap_execute_cmd_update" },
    { "ecall_openvdap_execute_cmd_delete" },
    { "ecall_openvdap_execute_cmd_query" },
    { "ecall_openvdap_execute_cmd_enc" },
    { "ecall_openvdap_execute_cmd_dec" },
    { "ecall_openvdap_execute_cmd_sign" },
    { "ecall_openvdap_execute_cmd_verify" },
...
typedef struct _ecall_openvdap_init_tee_args_t
{
    ...
    char* pubkey;
    char* addr;
} ecall_openvdap_init_tee_args_t;

typedef struct _ecall_openvdap_open_keynote_args_t
{
    oe_result_t oe_result;
    uint8_t* deepcopy_out_buffer;
    size_t deepcopy_out_buffer_size;
} ecall_openvdap_open_keynote_args_t;

typedef struct _ecall_openvdap_execute_cmd_args_t
{
    oe_result_t oe_result;
    uint8_t* deepcopy_out_buffer;
    size_t deepcopy_out_buffer_size;
    char* cmd;
    size_t cmd_len;
} ecall_openvdap_execute_cmd_args_t;

typedef struct _ecall_openvdap_close_keynote_args_t
{
    oe_result_t oe_result;
    uint8_t* deepcopy_out_buffer;
    size_t deepcopy_out_buffer_size;
} ecall_openvdap_close_keynote_args_t;

typedef struct _ecall_openvdap_execute_cmd_add_args_t
{
    oe_result_t oe_result;
    uint8_t* deepcopy_out_buffer;
    size_t deepcopy_out_buffer_size;
    ...
    size_t owner_len;
    char* id;
} ecall_openvdap_execute_cmd_add_args_t;

typedef struct _ecall_openvdap_execute_cmd_update_args_t
{
    oe_result_t oe_result;
    uint8_t* deepcopy_out_buffer;
    size_t deepcopy_out_buffer_size;
    ...
    char* sig;
    size_t sig_len;
} ecall_openvdap_execute_cmd_update_args_t;

typedef struct _ecall_openvdap_execute_cmd_delete_args_t
{
    oe_result_t oe_result;
    uint8_t* deepcopy_out_buffer;
    size_t deepcopy_out_buffer_size;
    ...
    char* sig;
    size_t sig_len;
} ecall_openvdap_execute_cmd_delete_args_t;

typedef struct _ecall_openvdap_execute_cmd_query_args_t
{
    oe_result_t oe_result;
    uint8_t* deepcopy_out_buffer;
    size_t deepcopy_out_buffer_size;
    ...
    size_t sig_len;
    char* res;
} ecall_openvdap_execute_cmd_query_args_t;

typedef struct _ecall_openvdap_execute_cmd_enc_args_t
{
    oe_result_t oe_result;
    uint8_t* deepcopy_out_buffer;
    size_t deepcopy_out_buffer_size;
    ...
    size_t sig_len;
    char* res;
} ecall_openvdap_execute_cmd_enc_args_t;

typedef struct _ecall_openvdap_execute_cmd_dec_args_t
{
    oe_result_t oe_result;
    uint8_t* deepcopy_out_buffer;
    size_t deepcopy_out_buffer_size;
    ...
    size_t sig_len;
    char* res;
} ecall_openvdap_execute_cmd_dec_args_t;

typedef struct _ecall_openvdap_execute_cmd_sign_args_t
{
    oe_result_t oe_result;
    uint8_t* deepcopy_out_buffer;
    size_t deepcopy_out_buffer_size;
    ...
    size_t msg_len;
    char* res;
} ecall_openvdap_execute_cmd_sign_args_t;

typedef struct _ecall_openvdap_execute_cmd_verify_args_t
{
    oe_result_t oe_result;
    uint8_t* deepcopy_out_buffer;
    size_t deepcopy_out_buffer_size;
    ...
    size_t sig_len;
    char* res;
} ecall_openvdap_execute_cmd_verify_args_t;
...
oe_result_t openvdap_ecall_openvdap_init_tee(
    ...
    const char* addr)
{
    ...
    /* Marshalling struct. */
    ecall_openvdap_init_tee_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_openvdap_init_tee_args_t));
    if (seed)
        OE_ADD_ARG_SIZE(_input_buffer_size, _args.seed_len, sizeof(char));
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_openvdap_init_tee_args_t));
    ...
    _pargs_in = (ecall_openvdap_init_tee_args_t*)_input_buffer;
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _openvdap_ecall_info_table[openvdap_fcn_id_ecall_openvdap_init_tee].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    _pargs_out = (ecall_openvdap_init_tee_args_t*)_output_buffer;
...
OE_WEAK_ALIAS(openvdap_ecall_openvdap_init_tee, ecall_openvdap_init_tee);

oe_result_t openvdap_ecall_openvdap_open_keynote(oe_enclave_t* enclave)
{
    oe_result_t _result = OE_FAILURE;
    ...
    /* Marshalling struct. */
    ecall_openvdap_open_keynote_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    /* Marshalling buffer and sizes. */
    size_t _input_buffer_size = 0;
    size_t _output_buffer_size = 0;
    size_t _total_buffer_size = 0;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_openvdap_open_keynote_args_t));
    /* There were no corresponding parameters. */
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_openvdap_open_keynote_args_t));
    /* There were no corresponding parameters. */
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_openvdap_open_keynote_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _openvdap_ecall_info_table[openvdap_fcn_id_ecall_openvdap_open_keynote].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_openvdap_open_keynote_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
...
OE_WEAK_ALIAS(openvdap_ecall_openvdap_open_keynote, ecall_openvdap_open_keynote);

oe_result_t openvdap_ecall_openvdap_execute_cmd(
    oe_enclave_t* enclave,
    const char* cmd)
{
    oe_result_t _result = OE_FAILURE;
    ...
    /* Marshalling struct. */
    ecall_openvdap_execute_cmd_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    /* Marshalling buffer and sizes. */
    size_t _input_buffer_size = 0;
    size_t _output_buffer_size = 0;
    size_t _total_buffer_size = 0;
    ...
    memset(&_args, 0, sizeof(_args));
    _args.cmd = (char*)cmd;
    _args.cmd_len = (cmd) ? (oe_strlen(cmd) + 1) : 0;

    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_openvdap_execute_cmd_args_t));
    if (cmd)
        OE_ADD_ARG_SIZE(_input_buffer_size, _args.cmd_len, sizeof(char));
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_openvdap_execute_cmd_args_t));
    /* There were no corresponding parameters. */
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_openvdap_execute_cmd_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (cmd)
        OE_WRITE_IN_PARAM(cmd, _args.cmd_len, sizeof(char), char*);
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _openvdap_ecall_info_table[openvdap_fcn_id_ecall_openvdap_execute_cmd].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_openvdap_execute_cmd_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
...
OE_WEAK_ALIAS(openvdap_ecall_openvdap_execute_cmd, ecall_openvdap_execute_cmd);

oe_result_t openvdap_ecall_openvdap_close_keynote(oe_enclave_t* enclave)
{
    oe_result_t _result = OE_FAILURE;
    ...
    /* Marshalling struct. */
    ecall_openvdap_close_keynote_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    /* Marshalling buffer and sizes. */
    size_t _input_buffer_size = 0;
    size_t _output_buffer_size = 0;
    size_t _total_buffer_size = 0;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_openvdap_close_keynote_args_t));
    /* There were no corresponding parameters. */
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_openvdap_close_keynote_args_t));
    /* There were no corresponding parameters. */
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_openvdap_close_keynote_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    /* There were no in nor in-out parameters. */
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _openvdap_ecall_info_table[openvdap_fcn_id_ecall_openvdap_close_keynote].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_openvdap_close_keynote_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
...
OE_WEAK_ALIAS(openvdap_ecall_openvdap_close_keynote, ecall_openvdap_close_keynote);

oe_result_t openvdap_ecall_openvdap_execute_cmd_add(
    oe_enclave_t* enclave,
    const char* msg,
    const char* sig,
    const char* owner,
    const char* id)
{
    ...
    /* Marshalling struct. */
    ecall_openvdap_execute_cmd_add_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    /* Marshalling buffer and sizes. */
    size_t _input_buffer_size = 0;
    size_t _output_buffer_size = 0;
    size_t _total_buffer_size = 0;
    ...
    _args.sig = (char*)sig;
    _args.sig_len = (sig) ? (oe_strlen(sig) + 1) : 0;
    _args.owner = (char*)owner;
    _args.owner_len = (owner) ? (oe_strlen(owner) + 1) : 0;
    _args.id = (char*)id;

    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_openvdap_execute_cmd_add_args_t));
    if (msg)
        OE_ADD_ARG_SIZE(_input_buffer_size, _args.msg_len, sizeof(char));
    if (sig)
        OE_ADD_ARG_SIZE(_input_buffer_size, _args.sig_len, sizeof(char));
    if (owner)
        OE_ADD_ARG_SIZE(_input_buffer_size, _args.owner_len, sizeof(char));
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_openvdap_execute_cmd_add_args_t));
    /* There were no corresponding parameters. */
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_openvdap_execute_cmd_add_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (msg)
        OE_WRITE_IN_PARAM(msg, _args.msg_len, sizeof(char), char*);
    if (sig)
        OE_WRITE_IN_PARAM(sig, _args.sig_len, sizeof(char), char*);
    if (owner)
        OE_WRITE_IN_PARAM(owner, _args.owner_len, sizeof(char), char*);
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _openvdap_ecall_info_table[openvdap_fcn_id_ecall_openvdap_execute_cmd_add].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_openvdap_execute_cmd_add_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
...
OE_WEAK_ALIAS(openvdap_ecall_openvdap_execute_cmd_add, ecall_openvdap_execute_cmd_add);

oe_result_t openvdap_ecall_openvdap_execute_cmd_update(
    oe_enclave_t* enclave,
    const char* id,
    const char* msg,
    const char* sig)
{
    ...
    /* Marshalling struct. */
    ecall_openvdap_execute_cmd_update_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    /* Marshalling buffer and sizes. */
    size_t _input_buffer_size = 0;
    size_t _output_buffer_size = 0;
    size_t _total_buffer_size = 0;
    ...
    memset(&_args, 0, sizeof(_args));
    _args.id = (char*)id;
    _args.id_len = (id) ? (oe_strlen(id) + 1) : 0;
    _args.msg = (char*)msg;
    _args.msg_len = (msg) ? (oe_strlen(msg) + 1) : 0;
    _args.sig = (char*)sig;
    _args.sig_len = (sig) ? (oe_strlen(sig) + 1) : 0;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_openvdap_execute_cmd_update_args_t));
    if (id)
        OE_ADD_ARG_SIZE(_input_buffer_size, _args.id_len, sizeof(char));
    if (msg)
        OE_ADD_ARG_SIZE(_input_buffer_size, _args.msg_len, sizeof(char));
    if (sig)
        OE_ADD_ARG_SIZE(_input_buffer_size, _args.sig_len, sizeof(char));
    ...
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_openvdap_execute_cmd_update_args_t));
    /* There were no corresponding parameters. */
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_openvdap_execute_cmd_update_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (id)
        OE_WRITE_IN_PARAM(id, _args.id_len, sizeof(char), char*);
    if (msg)
        OE_WRITE_IN_PARAM(msg, _args.msg_len, sizeof(char), char*);
    if (sig)
        OE_WRITE_IN_PARAM(sig, _args.sig_len, sizeof(char), char*);
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _openvdap_ecall_info_table[openvdap_fcn_id_ecall_openvdap_execute_cmd_update].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_openvdap_execute_cmd_update_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
...
OE_WEAK_ALIAS(openvdap_ecall_openvdap_execute_cmd_update, ecall_openvdap_execute_cmd_update);

oe_result_t openvdap_ecall_openvdap_execute_cmd_delete(
    oe_enclave_t* enclave,
    const char* id,
    const char* sig)
{
    ...
    /* Marshalling struct. */
    ecall_openvdap_execute_cmd_delete_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    /* Marshalling buffer and sizes. */
    size_t _input_buffer_size = 0;
    size_t _output_buffer_size = 0;
    size_t _total_buffer_size = 0;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_openvdap_execute_cmd_delete_args_t));
    if (id)
        OE_ADD_ARG_SIZE(_input_buffer_size, _args.id_len, sizeof(char));
    if (sig)
        OE_ADD_ARG_SIZE(_input_buffer_size, _args.sig_len, sizeof(char));
    ...
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_openvdap_execute_cmd_delete_args_t));
    /* There were no corresponding parameters. */
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_openvdap_execute_cmd_delete_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (id)
        OE_WRITE_IN_PARAM(id, _args.id_len, sizeof(char), char*);
    if (sig)
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _openvdap_ecall_info_table[openvdap_fcn_id_ecall_openvdap_execute_cmd_delete].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_openvdap_execute_cmd_delete_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
...
OE_WEAK_ALIAS(openvdap_ecall_openvdap_execute_cmd_delete, ecall_openvdap_execute_cmd_delete);

oe_result_t openvdap_ecall_openvdap_execute_cmd_query(
    oe_enclave_t* enclave,
    const char* id,
    const char* sig,
    const char* res)
{
    ...
    /* Marshalling struct. */
    ecall_openvdap_execute_cmd_query_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    /* Marshalling buffer and sizes. */
    size_t _input_buffer_size = 0;
    size_t _output_buffer_size = 0;
    size_t _total_buffer_size = 0;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_openvdap_execute_cmd_query_args_t));
    if (id)
        OE_ADD_ARG_SIZE(_input_buffer_size, _args.id_len, sizeof(char));
    if (sig)
        OE_ADD_ARG_SIZE(_input_buffer_size, _args.sig_len, sizeof(char));
    ...
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_openvdap_execute_cmd_query_args_t));
    /* There were no corresponding parameters. */
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_openvdap_execute_cmd_query_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (id)
        OE_WRITE_IN_PARAM(id, _args.id_len, sizeof(char), char*);
    if (sig)
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _openvdap_ecall_info_table[openvdap_fcn_id_ecall_openvdap_execute_cmd_query].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_openvdap_execute_cmd_query_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
...
OE_WEAK_ALIAS(openvdap_ecall_openvdap_execute_cmd_query, ecall_openvdap_execute_cmd_query);

oe_result_t openvdap_ecall_openvdap_execute_cmd_enc(
    oe_enclave_t* enclave,
    const char* id,
    const char* msg,
    const char* sig,
    const char* res)
{
    ...
    /* Marshalling struct. */
    ecall_openvdap_execute_cmd_enc_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    /* Marshalling buffer and sizes. */
    size_t _input_buffer_size = 0;
    size_t _output_buffer_size = 0;
    size_t _total_buffer_size = 0;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_openvdap_execute_cmd_enc_args_t));
    if (id)
        OE_ADD_ARG_SIZE(_input_buffer_size, _args.id_len, sizeof(char));
    if (msg)
        OE_ADD_ARG_SIZE(_input_buffer_size, _args.msg_len, sizeof(char));
    ...
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_openvdap_execute_cmd_enc_args_t));
    /* There were no corresponding parameters. */
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_openvdap_execute_cmd_enc_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (id)
        OE_WRITE_IN_PARAM(id, _args.id_len, sizeof(char), char*);
    if (msg)
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _openvdap_ecall_info_table[openvdap_fcn_id_ecall_openvdap_execute_cmd_enc].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_openvdap_execute_cmd_enc_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
...
OE_WEAK_ALIAS(openvdap_ecall_openvdap_execute_cmd_enc, ecall_openvdap_execute_cmd_enc);

oe_result_t openvdap_ecall_openvdap_execute_cmd_dec(
    oe_enclave_t* enclave,
    const char* id,
    const char* sig,
    const char* res)
{
    ...
    /* Marshalling struct. */
    ecall_openvdap_execute_cmd_dec_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    /* Marshalling buffer and sizes. */
    size_t _input_buffer_size = 0;
    size_t _output_buffer_size = 0;
    size_t _total_buffer_size = 0;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_openvdap_execute_cmd_dec_args_t));
    if (id)
        OE_ADD_ARG_SIZE(_input_buffer_size, _args.id_len, sizeof(char));
    if (sig)
        OE_ADD_ARG_SIZE(_input_buffer_size, _args.sig_len, sizeof(char));
    ...
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_openvdap_execute_cmd_dec_args_t));
    /* There were no corresponding parameters. */
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_openvdap_execute_cmd_dec_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (id)
        OE_WRITE_IN_PARAM(id, _args.id_len, sizeof(char), char*);
    if (sig)
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _openvdap_ecall_info_table[openvdap_fcn_id_ecall_openvdap_execute_cmd_dec].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_openvdap_execute_cmd_dec_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
...
OE_WEAK_ALIAS(openvdap_ecall_openvdap_execute_cmd_dec, ecall_openvdap_execute_cmd_dec);

oe_result_t openvdap_ecall_openvdap_execute_cmd_sign(
    oe_enclave_t* enclave,
    const char* id,
    const char* msg,
    const char* res)
{
    ...
    /* Marshalling struct. */
    ecall_openvdap_execute_cmd_sign_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    /* Marshalling buffer and sizes. */
    size_t _input_buffer_size = 0;
    size_t _output_buffer_size = 0;
    size_t _total_buffer_size = 0;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_openvdap_execute_cmd_sign_args_t));
    if (id)
        OE_ADD_ARG_SIZE(_input_buffer_size, _args.id_len, sizeof(char));
    if (msg)
        OE_ADD_ARG_SIZE(_input_buffer_size, _args.msg_len, sizeof(char));
    ...
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_openvdap_execute_cmd_sign_args_t));
    /* There were no corresponding parameters. */
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_openvdap_execute_cmd_sign_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (id)
        OE_WRITE_IN_PARAM(id, _args.id_len, sizeof(char), char*);
    if (msg)
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _openvdap_ecall_info_table[openvdap_fcn_id_ecall_openvdap_execute_cmd_sign].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_openvdap_execute_cmd_sign_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
...
OE_WEAK_ALIAS(openvdap_ecall_openvdap_execute_cmd_sign, ecall_openvdap_execute_cmd_sign);

oe_result_t openvdap_ecall_openvdap_execute_cmd_verify(
    oe_enclave_t* enclave,
    const char* id,
    const char* sig,
    const char* res)
{
    ...
    /* Marshalling struct. */
    ecall_openvdap_execute_cmd_verify_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    /* Marshalling buffer and sizes. */
    size_t _input_buffer_size = 0;
    size_t _output_buffer_size = 0;
    size_t _total_buffer_size = 0;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_openvdap_execute_cmd_verify_args_t));
    if (id)
        OE_ADD_ARG_SIZE(_input_buffer_size, _args.id_len, sizeof(char));
    if (sig)
        OE_ADD_ARG_SIZE(_input_buffer_size, _args.sig_len, sizeof(char));
    ...
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_openvdap_execute_cmd_verify_args_t));
    /* There were no corresponding parameters. */
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_openvdap_execute_cmd_verify_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (id)
        OE_WRITE_IN_PARAM(id, _args.id_len, sizeof(char), char*);
    if (sig)
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _openvdap_ecall_info_table[openvdap_fcn_id_ecall_openvdap_execute_cmd_verify].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_openvdap_execute_cmd_verify_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
...
OE_WEAK_ALIAS(openvdap_ecall_openvdap_execute_cmd_verify, ecall_openvdap_execute_cmd_verify);

oe_result_t openvdap_initialize_encryptor(
    oe_enclave_t* enclave,
    int* _retval,
    bool encrypt,
    const char* password,
    ...
    encryption_header_t* header)
{
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _openvdap_ecall_info_table[openvdap_fcn_id_initialize_encryptor].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(openvdap_initialize_encryptor, initialize_encryptor);

oe_result_t openvdap_encrypt_block(
    oe_enclave_t* enclave,
    int* _retval,
    bool encrypt,
    unsigned char* input_buf,
    ...
    size_t size)
{
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _openvdap_ecall_info_table[openvdap_fcn_id_encrypt_block].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(openvdap_encrypt_block, encrypt_block);

oe_result_t openvdap_close_encryptor(oe_enclave_t* enclave)
{
    oe_result_t _result = OE_FAILURE;
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _openvdap_ecall_info_table[openvdap_fcn_id_close_encryptor].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(openvdap_close_encryptor, close_encryptor);

oe_result_t openvdap_oe_get_sgx_report_ecall(
    oe_enclave_t* enclave,
    oe_result_t* _retval,
    ...
    sgx_report_t* report)
{
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _openvdap_ecall_info_table[openvdap_fcn_id_oe_get_sgx_report_ecall].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(openvdap_oe_get_sgx_report_ecall, oe_get_sgx_report_ecall);

oe_result_t openvdap_oe_get_report_v2_ecall(
    oe_enclave_t* enclave,
    oe_result_t* _retval,
    uint32_t flags,
    const void* opt_params,
    ...
    size_t* report_buffer_size)
{
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _openvdap_ecall_info_table[openvdap_fcn_id_oe_get_report_v2_ecall].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(openvdap_oe_get_report_v2_ecall, oe_get_report_v2_ecall);

oe_result_t openvdap_oe_verify_local_report_ecall(
    oe_enclave_t* enclave,
    oe_result_t* _retval,
    ...
    oe_report_t* parsed_report)
{
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _openvdap_ecall_info_table[openvdap_fcn_id_oe_verify_local_report_ecall].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(openvdap_oe_verify_local_report_ecall, oe_verify_local_report_ecall);

oe_result_t openvdap_oe_sgx_init_context_switchless_ecall(
    oe_enclave_t* enclave,
    oe_result_t* _retval,
    oe_host_worker_context_t* host_worker_contexts,
    uint64_t num_host_workers)
{
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _openvdap_ecall_info_table[openvdap_fcn_id_oe_sgx_init_context_switchless_ecall].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(openvdap_oe_sgx_init_context_switchless_ecall, oe_sgx_init_context_switchless_ecall);

oe_result_t openvdap_oe_sgx_switchless_enclave_worker_thread_ecall(
    oe_enclave_t* enclave,
    oe_enclave_worker_context_t* context)
{
    oe_result_t _result = OE_FAILURE;
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _openvdap_ecall_info_table[openvdap_fcn_id_oe_sgx_switchless_enclave_worker_thread_ecall].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(openvdap_oe_sgx_switchless_enclave_worker_thread_ecall, oe_sgx_switchless_enclave_worker_thread_ecall);

/**** Untrusted function IDs. ****/
enum
{
    openvdap_fcn_id_ocall_openvdap_println_string = 0,
    openvdap_fcn_id_ocall_openvdap_print_string = 1,
    openvdap_fcn_id_ocall_openvdap_print_error = 2,
    openvdap_fcn_id_ocall_openvdap_lstat = 3,
    openvdap_fcn_id_ocall_openvdap_stat = 4,
    openvdap_fcn_id_ocall_openvdap_fstat = 5,
    openvdap_fcn_id_ocall_openvdap_ftruncate = 6,
    openvdap_fcn_id_ocall_openvdap_getcwd = 7,
    openvdap_fcn_id_ocall_openvdap_getpid = 8,
    openvdap_fcn_id_ocall_openvdap_getuid = 9,
    openvdap_fcn_id_ocall_openvdap_getenv = 10,
    openvdap_fcn_id_ocall_openvdap_open64 = 11,
    openvdap_fcn_id_ocall_openvdap_close = 12,
    openvdap_fcn_id_ocall_openvdap_lseek64 = 13,
    openvdap_fcn_id_ocall_openvdap_read = 14,
    openvdap_fcn_id_ocall_openvdap_write = 15,
    openvdap_fcn_id_ocall_openvdap_fsync = 16,
    openvdap_fcn_id_ocall_openvdap_fcntl = 17,
    openvdap_fcn_id_ocall_openvdap_unlink = 18,
    openvdap_fcn_id_oe_syscall_epoll_create1_ocall = 19,
    openvdap_fcn_id_oe_syscall_epoll_wait_ocall = 20,
    openvdap_fcn_id_oe_syscall_epoll_wake_ocall = 21,
    openvdap_fcn_id_oe_syscall_epoll_ctl_ocall = 22,
    openvdap_fcn_id_oe_syscall_epoll_close_ocall = 23,
    openvdap_fcn_id_oe_syscall_open_ocall = 24,
    openvdap_fcn_id_oe_syscall_read_ocall = 25,
    openvdap_fcn_id_oe_syscall_write_ocall = 26,
    openvdap_fcn_id_oe_syscall_readv_ocall = 27,
    openvdap_fcn_id_oe_syscall_writev_ocall = 28,
    openvdap_fcn_id_oe_syscall_lseek_ocall = 29,
    openvdap_fcn_id_oe_syscall_pread_ocall = 30,
    openvdap_fcn_id_oe_syscall_pwrite_ocall = 31,
    openvdap_fcn_id_oe_syscall_close_ocall = 32,
    openvdap_fcn_id_oe_syscall_flock_ocall = 33,
    openvdap_fcn_id_oe_syscall_fsync_ocall = 34,
    openvdap_fcn_id_oe_syscall_fdatasync_ocall = 35,
    openvdap_fcn_id_oe_syscall_dup_ocall = 36,
    openvdap_fcn_id_oe_syscall_opendir_ocall = 37,
    openvdap_fcn_id_oe_syscall_readdir_ocall = 38,
    openvdap_fcn_id_oe_syscall_rewinddir_ocall = 39,
    openvdap_fcn_id_oe_syscall_closedir_ocall = 40,
    openvdap_fcn_id_oe_syscall_stat_ocall = 41,
    openvdap_fcn_id_oe_syscall_fstat_ocall = 42,
    openvdap_fcn_id_oe_syscall_access_ocall = 43,
    openvdap_fcn_id_oe_syscall_link_ocall = 44,
    openvdap_fcn_id_oe_syscall_unlink_ocall = 45,
    openvdap_fcn_id_oe_syscall_rename_ocall = 46,
    openvdap_fcn_id_oe_syscall_truncate_ocall = 47,
    openvdap_fcn_id_oe_syscall_ftruncate_ocall = 48,
    openvdap_fcn_id_oe_syscall_mkdir_ocall = 49,
    openvdap_fcn_id_oe_syscall_rmdir_ocall = 50,
    openvdap_fcn_id_oe_syscall_fcntl_ocall = 51,
    openvdap_fcn_id_oe_syscall_ioctl_ocall = 52,
    openvdap_fcn_id_oe_syscall_poll_ocall = 53,
    openvdap_fcn_id_oe_syscall_kill_ocall = 54,
    openvdap_fcn_id_oe_syscall_close_socket_ocall = 55,
    openvdap_fcn_id_oe_syscall_socket_ocall = 56,
    openvdap_fcn_id_oe_syscall_shutdown_sockets_device_ocall = 57,
    openvdap_fcn_id_oe_syscall_socketpair_ocall = 58,
    openvdap_fcn_id_oe_syscall_connect_ocall = 59,
    openvdap_fcn_id_oe_syscall_accept_ocall = 60,
    openvdap_fcn_id_oe_syscall_bind_ocall = 61,
    openvdap_fcn_id_oe_syscall_listen_ocall = 62,
    openvdap_fcn_id_oe_syscall_recvmsg_ocall = 63,
    openvdap_fcn_id_oe_syscall_sendmsg_ocall = 64,
    openvdap_fcn_id_oe_syscall_recv_ocall = 65,
    openvdap_fcn_id_oe_syscall_recvfrom_ocall = 66,
    openvdap_fcn_id_oe_syscall_send_ocall = 67,
    openvdap_fcn_id_oe_syscall_sendto_ocall = 68,
    openvdap_fcn_id_oe_syscall_recvv_ocall = 69,
    openvdap_fcn_id_oe_syscall_sendv_ocall = 70,
    openvdap_fcn_id_oe_syscall_shutdown_ocall = 71,
    openvdap_fcn_id_oe_syscall_setsockopt_ocall = 72,
    openvdap_fcn_id_oe_syscall_getsockopt_ocall = 73,
    openvdap_fcn_id_oe_syscall_getsockname_ocall = 74,
    openvdap_fcn_id_oe_syscall_getpeername_ocall = 75,
    openvdap_fcn_id_oe_syscall_getaddrinfo_open_ocall = 76,
    openvdap_fcn_id_oe_syscall_getaddrinfo_read_ocall = 77,
    openvdap_fcn_id_oe_syscall_getaddrinfo_close_ocall = 78,
    openvdap_fcn_id_oe_syscall_getnameinfo_ocall = 79,
    openvdap_fcn_id_oe_syscall_nanosleep_ocall = 80,
    openvdap_fcn_id_oe_syscall_clock_nanosleep_ocall = 81,
    openvdap_fcn_id_oe_syscall_getpid_ocall = 82,
    openvdap_fcn_id_oe_syscall_getppid_ocall = 83,
    openvdap_fcn_id_oe_syscall_getpgrp_ocall = 84,
    openvdap_fcn_id_oe_syscall_getuid_ocall = 85,
    openvdap_fcn_id_oe_syscall_geteuid_ocall = 86,
    openvdap_fcn_id_oe_syscall_getgid_ocall = 87,
    openvdap_fcn_id_oe_syscall_getegid_ocall = 88,
    openvdap_fcn_id_oe_syscall_getpgid_ocall = 89,
    openvdap_fcn_id_oe_syscall_getgroups_ocall = 90,
    openvdap_fcn_id_oe_syscall_uname_ocall = 91,
    openvdap_fcn_id_oe_get_supported_attester_format_ids_ocall = 92,
    openvdap_fcn_id_oe_get_qetarget_info_ocall = 93,
    openvdap_fcn_id_oe_get_quote_ocall = 94,
    openvdap_fcn_id_oe_get_quote_verification_collateral_ocall = 95,
    openvdap_fcn_id_oe_verify_quote_ocall = 96,
    openvdap_fcn_id_oe_sgx_get_cpuid_table_ocall = 97,
    openvdap_fcn_id_oe_sgx_backtrace_symbols_ocall = 98,
    openvdap_fcn_id_oe_sgx_thread_wake_wait_ocall = 99,
    openvdap_fcn_id_oe_sgx_wake_switchless_worker_ocall = 100,
    openvdap_fcn_id_oe_sgx_sleep_switchless_worker_ocall = 101,
    openvdap_fcn_id_untrusted_call_max = OE_ENUM_MAX
};

/**** OCALL marshalling structs. ****/
typedef struct _ocall_openvdap_println_string_args_t
{
    oe_result_t oe_result;
    uint8_t* deepcopy_out_buffer;
    size_t deepcopy_out_buffer_size;
    char* str;
    size_t str_len;
} ocall_openvdap_println_string_args_t;

typedef struct _ocall_openvdap_print_string_args_t
{
    oe_result_t oe_result;
    uint8_t* deepcopy_out_buffer;
    size_t deepcopy_out_buffer_size;
    char* str;
    size_t str_len;
} ocall_openvdap_print_string_args_t;

typedef struct _ocall_openvdap_print_error_args_t
{
    oe_result_t oe_result;
    uint8_t* deepcopy_out_buffer;
    size_t deepcopy_out_buffer_size;
    char* str;
    size_t str_len;
} ocall_openvdap_print_error_args_t;

typedef struct _ocall_openvdap_lstat_args_t
{
    oe_result_t oe_result;
    uint8_t* deepcopy_out_buffer;
    size_t deepcopy_out_buffer_size;
    ...
    size_t size;
    int ocall_errno;
} ocall_openvdap_lstat_args_t;

typedef struct _ocall_openvdap_stat_args_t
{
    oe_result_t oe_result;
    uint8_t* deepcopy_out_buffer;
    size_t deepcopy_out_buffer_size;
    ...
    struct oe_stat_t* buf;
    size_t size;
} ocall_openvdap_stat_args_t;

typedef struct _ocall_openvdap_fstat_args_t
{
    oe_result_t oe_result;
    uint8_t* deepcopy_out_buffer;
    size_t deepcopy_out_buffer_size;
    ...
    struct oe_stat_t* buf;
    size_t size;
} ocall_openvdap_fstat_args_t;

typedef struct _ocall_openvdap_ftruncate_args_t
{
    oe_result_t oe_result;
    uint8_t* deepcopy_out_buffer;
    size_t deepcopy_out_buffer_size;
    ...
    int fd;
    oe_off_t length;
} ocall_openvdap_ftruncate_args_t;

typedef struct _ocall_openvdap_getcwd_args_t
{
    oe_result_t oe_result;
    uint8_t* deepcopy_out_buffer;
    size_t deepcopy_out_buffer_size;
    ...
    size_t size;
    int ocall_errno;
} ocall_openvdap_getcwd_args_t;

typedef struct _ocall_openvdap_getpid_args_t
{
    oe_result_t oe_result;
    uint8_t* deepcopy_out_buffer;
    size_t deepcopy_out_buffer_size;
    int oe_retval;
} ocall_openvdap_getpid_args_t;

typedef struct _ocall_openvdap_getuid_args_t
{
    oe_result_t oe_result;
    uint8_t* deepcopy_out_buffer;
    size_t deepcopy_out_buffer_size;
    int oe_retval;
} ocall_openvdap_getuid_args_t;

typedef struct _ocall_openvdap_getenv_args_t
{
    oe_result_t oe_result;
    uint8_t* deepcopy_out_buffer;
    size_t deepcopy_out_buffer_size;
    ...
    char* name;
    size_t name_len;
} ocall_openvdap_getenv_args_t;

typedef struct _ocall_openvdap_open64_args_t
{
    oe_result_t oe_result;
    uint8_t* deepcopy_out_buffer;
    size_t deepcopy_out_buffer_size;
    ...
    int flags;
    oe_mode_t mode;
} ocall_openvdap_open64_args_t;

typedef struct _ocall_openvdap_close_args_t
{
    oe_result_t oe_result;
    uint8_t* deepcopy_out_buffer;
    size_t deepcopy_out_buffer_size;
    int oe_retval;
    int fd;
} ocall_openvdap_close_args_t;

typedef struct _ocall_openvdap_lseek64_args_t
{
    oe_result_t oe_result;
    uint8_t* deepcopy_out_buffer;
    size_t deepcopy_out_buffer_size;
    ...
    int whence;
    int ocall_errno;
} ocall_openvdap_lseek64_args_t;

typedef struct _ocall_openvdap_read_args_t
{
    oe_result_t oe_result;
    uint8_t* deepcopy_out_buffer;
    size_t deepcopy_out_buffer_size;
    ...
    size_t count;
    int ocall_errno;
} ocall_openvdap_read_args_t;

typedef struct _ocall_openvdap_write_args_t
{
    oe_result_t oe_result;
    uint8_t* deepcopy_out_buffer;
    size_t deepcopy_out_buffer_size;
    ...
    size_t count;
    int ocall_errno;
} ocall_openvdap_write_args_t;

typedef struct _ocall_openvdap_fsync_args_t
{
    oe_result_t oe_result;
    uint8_t* deepcopy_out_buffer;
    size_t deepcopy_out_buffer_size;
    int oe_retval;
    int fd;
} ocall_openvdap_fsync_args_t;

typedef struct _ocall_openvdap_fcntl_args_t
{
    oe_result_t oe_result;
    uint8_t* deepcopy_out_buffer;
    size_t deepcopy_out_buffer_size;
    ...
    size_t size;
    int ocall_errno;
} ocall_openvdap_fcntl_args_t;

typedef struct _ocall_openvdap_unlink_args_t
{
    oe_result_t oe_result;
    uint8_t* deepcopy_out_buffer;
    size_t deepcopy_out_buffer_size;
...
static void ocall_ocall_openvdap_println_string(
    ...
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_openvdap_println_string_args_t* _pargs_in = (ocall_openvdap_println_string_args_t*)input_buffer;
    ocall_openvdap_println_string_args_t* _pargs_out = (ocall_openvdap_println_string_args_t*)output_buffer;
...
static void ocall_ocall_openvdap_print_string(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_openvdap_print_string_args_t* _pargs_in = (ocall_openvdap_print_string_args_t*)input_buffer;
    ocall_openvdap_print_string_args_t* _pargs_out = (ocall_openvdap_print_string_args_t*)output_buffer;
...
static void ocall_ocall_openvdap_print_error(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_openvdap_print_error_args_t* _pargs_in = (ocall_openvdap_print_error_args_t*)input_buffer;
    ocall_openvdap_print_error_args_t* _pargs_out = (ocall_openvdap_print_error_args_t*)output_buffer;
...
static void ocall_ocall_openvdap_lstat(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_openvdap_lstat_args_t* _pargs_in = (ocall_openvdap_lstat_args_t*)input_buffer;
    ocall_openvdap_lstat_args_t* _pargs_out = (ocall_openvdap_lstat_args_t*)output_buffer;
    ...
    if (_pargs_in->buf)
        OE_SET_IN_OUT_POINTER(buf, 1, _pargs_in->size, struct oe_stat_t*);

    /* Set out and in-out pointers. */
    /* In-out parameters are copied to output buffer. */
    if (_pargs_in->buf)
        OE_COPY_AND_SET_IN_OUT_POINTER(buf, 1, _pargs_in->size, struct oe_stat_t*);

    /* Call user function. */
    _pargs_out->oe_retval = ocall_openvdap_lstat(
...
static void ocall_ocall_openvdap_stat(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_openvdap_stat_args_t* _pargs_in = (ocall_openvdap_stat_args_t*)input_buffer;
    ocall_openvdap_stat_args_t* _pargs_out = (ocall_openvdap_stat_args_t*)output_buffer;
    ...
    /* Call user function. */
    _pargs_out->oe_retval = ocall_openvdap_stat(
        (const char*)_pargs_in->path,
        _pargs_in->buf,
        _pargs_in->size);
...
static void ocall_ocall_openvdap_fstat(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_openvdap_fstat_args_t* _pargs_in = (ocall_openvdap_fstat_args_t*)input_buffer;
    ocall_openvdap_fstat_args_t* _pargs_out = (ocall_openvdap_fstat_args_t*)output_buffer;
    ...
    /* Call user function. */
    _pargs_out->oe_retval = ocall_openvdap_fstat(
        _pargs_in->fd,
        _pargs_in->buf,
        _pargs_in->size);
...
static void ocall_ocall_openvdap_ftruncate(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_openvdap_ftruncate_args_t* _pargs_in = (ocall_openvdap_ftruncate_args_t*)input_buffer;
    ocall_openvdap_ftruncate_args_t* _pargs_out = (ocall_openvdap_ftruncate_args_t*)output_buffer;
    ...
    /* Call user function. */
    _pargs_out->oe_retval = ocall_openvdap_ftruncate(
        _pargs_in->fd,
        _pargs_in->length);
...
static void ocall_ocall_openvdap_getcwd(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_openvdap_getcwd_args_t* _pargs_in = (ocall_openvdap_getcwd_args_t*)input_buffer;
    ocall_openvdap_getcwd_args_t* _pargs_out = (ocall_openvdap_getcwd_args_t*)output_buffer;
    ...
    /* In-out parameters are copied to output buffer. */
    if (_pargs_in->buf)
        OE_SET_OUT_POINTER(buf, 1, _pargs_in->size, char*);

    /* Call user function. */
    _pargs_out->oe_retval = ocall_openvdap_getcwd(
        _pargs_in->buf,
        _pargs_in->size);
...
static void ocall_ocall_openvdap_getpid(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_openvdap_getpid_args_t* _pargs_in = (ocall_openvdap_getpid_args_t*)input_buffer;
    ocall_openvdap_getpid_args_t* _pargs_out = (ocall_openvdap_getpid_args_t*)output_buffer;
    ...
    /* Call user function. */
    _pargs_out->oe_retval = ocall_openvdap_getpid(
    );
...
static void ocall_ocall_openvdap_getuid(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_openvdap_getuid_args_t* _pargs_in = (ocall_openvdap_getuid_args_t*)input_buffer;
    ocall_openvdap_getuid_args_t* _pargs_out = (ocall_openvdap_getuid_args_t*)output_buffer;
    ...
    /* Call user function. */
    _pargs_out->oe_retval = ocall_openvdap_getuid(
    );
...
static void ocall_ocall_openvdap_getenv(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_openvdap_getenv_args_t* _pargs_in = (ocall_openvdap_getenv_args_t*)input_buffer;
    ocall_openvdap_getenv_args_t* _pargs_out = (ocall_openvdap_getenv_args_t*)output_buffer;
    ...
    /* Call user function. */
    _pargs_out->oe_retval = ocall_openvdap_getenv(
...
static void ocall_ocall_openvdap_open64(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_openvdap_open64_args_t* _pargs_in = (ocall_openvdap_open64_args_t*)input_buffer;
    ocall_openvdap_open64_args_t* _pargs_out = (ocall_openvdap_open64_args_t*)output_buffer;
    ...
    /* Set in and in-out pointers. */
    if (_pargs_in->filename)
        OE_SET_IN_POINTER(filename, _pargs_in->filename_len, sizeof(char), char*);
    ...
    /* Call user function. */
    _pargs_out->oe_retval = ocall_openvdap_open64(
        (const char*)_pargs_in->filename,
        _pargs_in->flags,
        _pargs_in->mode);
...
static void ocall_ocall_openvdap_close(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_openvdap_close_args_t* _pargs_in = (ocall_openvdap_close_args_t*)input_buffer;
    ocall_openvdap_close_args_t* _pargs_out = (ocall_openvdap_close_args_t*)output_buffer;
    ...
    /* Call user function. */
    _pargs_out->oe_retval = ocall_openvdap_close(
        _pargs_in->fd);
...
static void ocall_ocall_openvdap_lseek64(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_openvdap_lseek64_args_t* _pargs_in = (ocall_openvdap_lseek64_args_t*)input_buffer;
    ocall_openvdap_lseek64_args_t* _pargs_out = (ocall_openvdap_lseek64_args_t*)output_buffer;
    ...
    /* Call user function. */
    _pargs_out->oe_retval = ocall_openvdap_lseek64(
        _pargs_in->fd,
        _pargs_in->offset,
        _pargs_in->whence);
...
static void ocall_ocall_openvdap_read(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_openvdap_read_args_t* _pargs_in = (ocall_openvdap_read_args_t*)input_buffer;
    ocall_openvdap_read_args_t* _pargs_out = (ocall_openvdap_read_args_t*)output_buffer;
    ...
    /* Call user function. */
    _pargs_out->oe_retval = ocall_openvdap_read(
        _pargs_in->fd,
        _pargs_in->buf,
        _pargs_in->count);
...
static void ocall_ocall_openvdap_write(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_openvdap_write_args_t* _pargs_in = (ocall_openvdap_write_args_t*)input_buffer;
    ocall_openvdap_write_args_t* _pargs_out = (ocall_openvdap_write_args_t*)output_buffer;
    ...
    /* Call user function. */
    _pargs_out->oe_retval = ocall_openvdap_write(
        _pargs_in->fd,
...
static void ocall_ocall_openvdap_fsync(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_openvdap_fsync_args_t* _pargs_in = (ocall_openvdap_fsync_args_t*)input_buffer;
    ocall_openvdap_fsync_args_t* _pargs_out = (ocall_openvdap_fsync_args_t*)output_buffer;
    ...
    /* Call user function. */
    _pargs_out->oe_retval = ocall_openvdap_fsync(
        _pargs_in->fd);
...
static void ocall_ocall_openvdap_fcntl(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_openvdap_fcntl_args_t* _pargs_in = (ocall_openvdap_fcntl_args_t*)input_buffer;
    ocall_openvdap_fcntl_args_t* _pargs_out = (ocall_openvdap_fcntl_args_t*)output_buffer;
    ...
    /* Set in and in-out pointers. */
    if (_pargs_in->arg)
        OE_SET_IN_POINTER(arg, 1, _pargs_in->size, void*);
    ...
    /* Call user function. */
    _pargs_out->oe_retval = ocall_openvdap_fcntl(
        _pargs_in->fd,
        _pargs_in->cmd,
        _pargs_in->arg,
        _pargs_in->size);
...
static void ocall_ocall_openvdap_unlink(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_openvdap_unlink_args_t* _pargs_in = (ocall_openvdap_unlink_args_t*)input_buffer;
    ocall_openvdap_unlink_args_t* _pargs_out = (ocall_openvdap_unlink_args_t*)output_buffer;
    ...
    /* Call user function. */
    _pargs_out->oe_retval = ocall_openvdap_unlink(
...
static oe_ocall_func_t _openvdap_ocall_function_table[] = {
    (oe_ocall_func_t) ocall_ocall_openvdap_println_string,
    (oe_ocall_func_t) ocall_ocall_openvdap_print_string,
    (oe_ocall_func_t) ocall_ocall_openvdap_print_error,
    (oe_ocall_func_t) ocall_ocall_openvdap_lstat,
    (oe_ocall_func_t) ocall_ocall_openvdap_stat,
    (oe_ocall_func_t) ocall_ocall_openvdap_fstat,
    (oe_ocall_func_t) ocall_ocall_openvdap_ftruncate,
    (oe_ocall_func_t) ocall_ocall_openvdap_getcwd,
    (oe_ocall_func_t) ocall_ocall_openvdap_getpid,
    (oe_ocall_func_t) ocall_ocall_openvdap_getuid,
    (oe_ocall_func_t) ocall_ocall_openvdap_getenv,
    (oe_ocall_func_t) ocall_ocall_openvdap_open64,
    (oe_ocall_func_t) ocall_ocall_openvdap_close,
    (oe_ocall_func_t) ocall_ocall_openvdap_lseek64,
    (oe_ocall_func_t) ocall_ocall_openvdap_read,
    (oe_ocall_func_t) ocall_ocall_openvdap_write,
    (oe_ocall_func_t) ocall_ocall_openvdap_fsync,
    (oe_ocall_func_t) ocall_ocall_openvdap_fcntl,
    (oe_ocall_func_t) ocall_ocall_openvdap_unlink,
...
oe_result_t oe_create_openvdap_enclave(
    const char* path,
    ...
    oe_enclave_t** enclave)
{
    return oe_create_enclave(
               ...
               settings,
               setting_count,
               _openvdap_ocall_function_table,
               102,
               _openvdap_ecall_info_table,
                20,
               enclave);
}
